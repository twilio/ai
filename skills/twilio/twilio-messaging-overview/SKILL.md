...
|---------|---------------|------------|-------------------|-------|-------|
| **SMS/MMS** | `+15551234567` (E.164) | MMS: images/video, US/CA only | No | Global (180+ countries) | `twilio-sms-send-message` |
...
| Send rich media globally | WhatsApp | Images, docs, video work worldwide (MMS is US/CA only) |
